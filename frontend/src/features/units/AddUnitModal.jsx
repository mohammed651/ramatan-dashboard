...
import { addUnit, fetchUnits } from "./unitsSlice";

export default function AddUnitModal({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.project_id) return alert("اختر مشروع");
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        <h3 className="text-lg font-semibold mb-4">إضافة وحدة</h3>
